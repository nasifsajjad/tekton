...
## Going-live checklist (once, after first deploy)
...
- Hero video files use the standard media cache policy so they can be replaced
  in place without leaving returning visitors on an outdated version.
